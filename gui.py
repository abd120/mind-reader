...
set_1_cb = Checkbutton(root, text="I see my number.")
set_1_cb.bind("<Button-1>", bind_button1)
set_1_cb.grid(row=5,  column=2, padx=4, pady=4)
...
set_2_cb = Checkbutton(root, text="I see my number.")
set_2_cb.bind("<Button-1>", bind_button2)
set_2_cb.grid(row=9, column=2, padx=4, pady=4)
...
set_3_cb = Checkbutton(root, text="I see my number.")
set_3_cb.bind("<Button-1>", bind_button3)
set_3_cb.grid(row=13,  column=2, padx=4, pady=4)
...
set_4_cb = Checkbutton(root, text="I see my number.")
set_4_cb.bind("<Button-1>", bind_button4)
set_4_cb.grid(row=16,  column=2, padx=4, pady=4)
...
set_5_cb = Checkbutton(root, text="I see my number.")
set_5_cb.bind("<Button-1>", bind_button5)
set_5_cb.grid(row=20,  column=2, padx=4, pady=4)
...
set_6_cb = Checkbutton(root, text="I see my number.")
set_6_cb.bind("<Button-1>", bind_button6)
set_6_cb.grid(row=24,  column=2, padx=4, pady=4)
