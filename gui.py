...
setone3 = Checkbutton(root, text="I see my number.", variable=CheckVar1)
...
settwo3 = Checkbutton(root, text="I see my number.", variable=CheckVar2)
...
setthree3 = Checkbutton(root, text="I see my number.", variable=CheckVar3)
...
setfour3 = Checkbutton(root, text="I see my number.", variable=CheckVar4)
...
setfive3 = Checkbutton(root, text="I see my number.", variable=CheckVar5)
...
setsix3 = Checkbutton(root, text="I see my number.", variable=CheckVar6)
